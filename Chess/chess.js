...
const board = [
    ...
    {color: 'light', figure: figurs.white.rook, active: false}, {color: 'dark',figure: figurs.white.knight, active: false}, {color: 'white',figure: figurs.white.bishop, active: false}, {color: 'dark', figure: figurs.white.king, active: false}, {color: 'white', figure: figurs.white.queen, active: false}, {color: 'dark', figure: figurs.white.bishop, active: false}, {color: 'white', figure: figurs.white.knight, active: false}, {color: 'dark', figure: figurs.white.rook, active: false},
];
